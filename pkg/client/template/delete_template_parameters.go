...
type DeleteTemplateParams struct {
	...
	*/
	Request *models.ModelsDeleteTemplateRequest
...
// WithRequest adds the request to the delete template params
func (o *DeleteTemplateParams) WithRequest(request *models.ModelsDeleteTemplateRequest) *DeleteTemplateParams {
	o.SetRequest(request)
	return o
}

// SetRequest adds the request to the delete template params
func (o *DeleteTemplateParams) SetRequest(request *models.ModelsDeleteTemplateRequest) {
	o.Request = request
}

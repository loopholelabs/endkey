...
// @Accept       json
// @Produce      json
// @Param        request  body models.CreateClientCertificateRequest  true  "Create Client Certificate Request"
// @Success      200  {object} models.ClientCertificateResponse
...
// @Router       /certificate/client [post]
func (a *Certificate) CreateClient(ctx *fiber.Ctx) error {
	...
	body := new(models.CreateClientCertificateRequest)
	...
	templ, err := ak.Edges.ClientTemplateOrErr()
	if err != nil {
		_, err = ak.Edges.ServerTemplateOrErr()
		if err == nil {

...
var _ loader.Loader = (*Client)(nil)
...
func (l *Client) RootCA(ctx context.Context) (*x509.CertPool, error) {
...
func (l *Client) Certificate(ctx context.Context) (*tls.Certificate, error) {

...
const (
	// Label holds the string label denoting the servertemplate type in the database.
	...
	// Table holds the table name of the servertemplate in the database.
	Table = "server_templates"
	// AuthorityTable is the table that holds the authority relation/edge.
	AuthorityTable = "server_templates"
	...
	AuthorityColumn = "authority_server_templates"
	...
	APIKeysColumn = "server_template_api_keys"
)

// Columns holds all SQL columns for servertemplate fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldName,
...
// ForeignKeys holds the SQL foreign-keys that are owned by the "server_templates"
// table and are not defined as standalone fields in the schema.
var ForeignKeys = []string{
	"authority_server_templates",
}
